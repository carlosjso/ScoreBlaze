...
def generate_league_bracket(
    ...
    return service.generate_bracket(league_id, payload, current_user)
...
def convert_league_to_elimination(
    ...
    return service.convert_to_single_elimination(league_id, payload, current_user)
...
def reset_league_bracket(
    ...
    service.reset_bracket(league_id, current_user)
