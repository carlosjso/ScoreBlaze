...
from .domain import (
    ...
    ScoreboardRealtimeEventType,
    ScoreboardRealtimeMessageType,
    ScoreboardTeamKey,
)

ScoreboardEventType = MatchEventType
ScoreboardEventStatus = MatchEventStatus
...
class ScoreboardEventOut(BaseModel):
    ...
    status: ScoreboardEventStatus = MatchEventStatus.ACTIVE
    created_at: datetime
...
class ScoreboardRealtimeHistoryEvent(BaseModel):
    ...
    type: ScoreboardRealtimeEventType
...
class ScoreboardRealtimeState(BaseModel):
    ...
    controlMode: ScoreboardControlMode = ScoreboardControlMode.BUTTONS
    period: int = Field(..., ge=1)
...
class ScoreboardRealtimeStateMessage(BaseModel):
    type: ScoreboardRealtimeMessageType = ScoreboardRealtimeMessageType.SCOREBOARD_STATE
