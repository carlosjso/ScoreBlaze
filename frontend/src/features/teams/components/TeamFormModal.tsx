          ...
          <div className="mx-auto max-w-[360px]">
            <div className="flex flex-col items-center">
              ...
              <div className="mt-3 flex flex-wrap items-center justify-center gap-2">
                ...
                {logoBase64 && (
                  <button type="button" onClick={clearLogo} disabled={loading} className="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 transition hover:bg-slate-100 disabled:opacity-50">
                    <Trash2 size={12} /> Quitar
                  </button>
                )}
              </div>
              {logoError && <p className="mt-2 text-center text-xs font-medium text-red-600">{logoError}</p>}
            </div>
